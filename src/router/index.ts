...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'file-assets/create',
        name: 'FileAssetCreate',
        component: () => import('@/views/file-assets/FileAssetCreatePage.vue'),
        meta: { title: '新建文件资产' },
      },
      {
        path: 'file-assets/:id',
        name: 'FileAssetDetail',
        component: () => import('@/views/file-assets/FileAssetDetailPage.vue'),
        meta: { title: '文件资产详情' },
      },
      {
        path: 'classification/tasks',
        name: 'ClassifyTasks',
        component: () => import('@/views/classification/TaskTabPage.vue'),
        meta: { title: '分类任务', icon: 'Finished' },
      },
      {
        path: 'classification/file-tasks',
        name: 'FileClassifyTasks',
        component: () => import('@/views/classification/TaskTabPage.vue'),
        meta: { title: '文件分类任务' },
        props: () => ({ tab: 'file' }),
      },
      ...
      {
        path: 'classification/file-tasks/:id',
        name: 'FileClassifyTaskDetail',
        component: () => import('@/views/file-classification/FileTaskDetailPage.vue'),
        meta: { title: '文件分类任务详情' },
      },
      {
        path: 'classification/file-tasks/:id/edit',
        name: 'FileTaskEdit',
        component: () => import('@/views/file-classification/FileTaskEditPage.vue'),
        meta: { title: '编辑文件分类任务' },
      },
      {
        path: 'file-classification-tasks/:id',
